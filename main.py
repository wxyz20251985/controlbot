# Sirul Member Control Bot - v21.5 + nest-asyncio
# Warns after 4 days, Kicks after 5 days
# Works in ANY group where added as admin
...
import nest_asyncio
nest_asyncio.apply()  # REQUIRED: Fixes "event loop already running" on Python 3.13
...
if not BOT_TOKEN:
    raise ValueError("BOT_TOKEN not set! Set in Render or export locally.")
